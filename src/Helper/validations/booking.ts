...
const bookingValidator = Yup.object()
    ...
    .shape({
        date: Yup.string()
            .required(errorMessages.required('Check in/out dates')),
        ...
        personalDetails: Yup.object()
            ...
            .shape({
                ...
                phoneNumber: Yup.string()
                    ...
                    .matches(/^([\d()\-+]){10,15}$/, errorMessages.validType('Phone Number'))
        ...
        location: Yup.object().shape({
            billingAddress: Yup.string().required(errorMessages.required('Billing Address')),
            billingCountry: Yup.string().required(errorMessages.required('Billing Country')),
